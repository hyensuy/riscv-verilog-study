...
module SMU_RV32I_System (
  ...
  parameter CLOCK_FREQ = 10_000_000;  	//for UART
...
`else
	always @(posedge clk)
`endif
    reset_ff_pipe[7:0] <= {reset_ff_pipe[6:0], reset};
  
  assign reset_ff = ~reset_ff_pipe[7] & reset_ff_pipe[6]; // _____|---|_____
